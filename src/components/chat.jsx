...
const Chat = () => {
    ...
    const { user, loading, allUsers, usersLoader } = useFirebase()
        ...
        <div className="flex h-screen antialiased text-gray-800 w-full">
            <div className="md:flex md:flex-row  md:h-full  w-full overflow-x-hidden">
                ...
                <div className="flex flex-col flex-auto h-full ">
                    <div className="flex flex-col space-y-1  col-span-12 bg-white fixed top-0 w-full z-50">
                    ...
                    <div
                        className="flex flex-col flex-auto flex-shrink-0  bg-gray-100 h-full w-full "
                    >

                        <div className="flex flex-col h-full overflow-x-auto mt-12">

                            <div className="flex flex-col h-full">

                                {chatLoader ? <div className="w-full h-full flex items-center justify-center">
                                    <Loader />
                                </div> :
                                    <div className="grid grid-cols-12 gap-y-2 mt-auto">
                                        {chatHistory.map((item) => {

                                            return (
                                                (item.reciverId !== selectedUser.id ? <div className="col-start-1 col-end-8 p-3 rounded-lg">
